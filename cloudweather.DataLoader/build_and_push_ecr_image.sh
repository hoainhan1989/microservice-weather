...
aws ecr get-login-password --region ap-southeast-1 --profile weather_ecr_agent | docker login --username AWS --password-stdin 633282583713.dkr.ecr.ap-southeast-1.amazonaws.com
